...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/play-single.css">

    <!-- 肉球アイコンなどのfontawesome読み込み用 -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">

    <!-- googlefontの読み込みと適用 -->
    <!-- maru gothicを利用、boldの値は適当 -->
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="card__display">
                <div class="container card__box pd10 mb40"></div>
                    ...
                    <div class="card__block">
                        ...
                        <div class="card__content">
                            ...
                            <div class="card__text">
                                <div class="card__address">●住所：徳島市〇〇〇〇〇-〇〇</div>
                                <div class="card__number">●お問い合わせ：〇〇〇-〇〇-〇〇〇〇</div>
                                <div class="card__url">aaaaaaaaaaaaaaaa.com</div>
                            </div>
                        </div>
            ...
            <div class="more__btn mb60">
                <img src="../assets/img/more-btn.png">
            </div>
            ...
            <div class="comments flex mt100">
                ...
                <div class="comments__area tc mt40">
                    <div class="pd40">
                        <h2 class="fs24">公園名の口コミ一覧</h2>
                        <div class="comments__archive mt40">
                            <p>口コミのテキストが入ります。</p>
                        </div>
                        <div class="comments__archive mt20">
                            <p>口コミのテキストが入ります。</p>
                        </div>
                    </div>
                </div>
