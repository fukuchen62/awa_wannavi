...
<main>
    ...
    <div class="container">
        <div class="banner__head">食べる</div>
        ...
        <!-- メインのタイトル -->
        <h2 class="h2__title bgPK mb20">ペットホテル</h2>
        ...
        <!-- 一つ目のカテゴリのカード群 -->
        <!-- コンテンツのサブタイトル -->
        <h2 class="sub__title bgPK mb20"><i class="fa-solid fa-paw"></i> 徳島市エリア</h2>
        ...
        <!-- コンテンツのサブタイトル -->
        <h2 class="sub__title bgPK mb20"><i class="fa-solid fa-paw"></i> 県東エリア</h2>
        ...
        <!-- コンテンツのサブタイトル -->
        <h2 class="sub__title bgPK mb20"><i class="fa-solid fa-paw"></i> 県西エリア</h2>
        ...
        <!-- コンテンツのサブタイトル -->
        <h2 class="sub__title bgPK mb20"><i class="fa-solid fa-paw"></i> 県南エリア</h2>
